...
using CreativeTim.Argon.DotNetCore.Free.Services;
...
namespace CreativeTim.Argon.DotNetCore.Free
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            var connectionString = StringCon.ConString();
            ...
            #region CONEXAO POSTGRES

            services.AddDbContext<Context>(
                opt => opt.UseNpgsql(connectionString, sql =>
            ...
            services.ConfigureApplicationCookie(options =>
            {
                ...
                options.ExpireTimeSpan = TimeSpan.FromMinutes(300);//5 Horas
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            #region CONFIGURAÇÂO ENVIO ALERTA EMAIL

            var serviceFactory = app.ApplicationServices.GetRequiredService<IServiceScopeFactory>();
            JobManager.Initialize(new CreativeTim.Argon.DotNetCore.Free.Services.EmailsSchedule.ServicosRegistry(serviceFactory));

            #endregion

            #region Cabecalhos HEADERS

            app.Use(async (context, next) =>
            {
                //Não adicionar a politica comentada! 
                //context.Response.Headers.Add("Content-Security-Policy", "default-src 'self', cdn.jsdelivr.net, *.google.com ,*.gstatic.com, *.googleapis.com, ajax.aspnetcdn.com, cdnjs.cloudflare.com");
